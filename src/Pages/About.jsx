      ...
      <main className="pt-20 font-poppins bg-black min-h-screen text-white">
        ...
        <section className="w-full bg-gradient-to-b from-zinc-950 via-black to-black py-20 md:py-28 px-6 md:px-12 lg:px-24 relative overflow-hidden">
          ...
          <div className="max-w-screen-2xl mx-auto text-center relative z-10">
            ...
            {/* Main Headline */}
            <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl text-white mb-8 leading-[1.15] max-w-5xl mx-auto">
            ...
            <div className="flex flex-wrap justify-center items-center gap-4">
              <Link
                to="/contact"
                className="inline-flex items-center gap-3 bg-gradient-to-r from-orange-500 to-amber-600 hover:from-orange-600 hover:to-amber-700 text-black text-base md:text-lg font-bold px-8 py-4 rounded-xl shadow-lg shadow-orange-500/25 hover:shadow-orange-500/40 transition-all duration-300 transform hover:-translate-y-0.5"
              >
          ...
          <div className="max-w-screen-2xl mx-auto">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
              <div>
                ...
                <h2 className="text-3xl md:text-4xl  text-white mb-8 leading-tight">
        ...
        <section className="w-full bg-gradient-to-r from-zinc-950 via-orange-950/30 to-zinc-950 py-16 px-6 md:px-12 border-y border-zinc-800">
          <div className="max-w-screen-xl mx-auto text-center">
            ...
            <div className="flex flex-wrap justify-center items-center gap-4">
              <Link
                to="/contact"
                className="inline-flex items-center gap-3 bg-gradient-to-r from-orange-500 to-amber-600 hover:from-orange-600 hover:to-amber-700 text-black font-bold px-8 py-4 rounded-xl shadow-lg shadow-orange-500/25 transition-all"
              >
                <span>Get a Free Design Consultation →</span>
              </Link>
              <a

...
import { ArrowRight, Award, Factory, ShieldCheck, Wrench, Sparkles } from "lucide-react";
      ...
      <main className="pt-20 font-poppins bg-black min-h-screen text-white">
        ...
        <section className="w-full bg-gradient-to-b from-zinc-950 via-black to-black py-20 md:py-28 px-6 md:px-12 lg:px-24 relative overflow-hidden">
          ...
          <div className="max-w-screen-2xl mx-auto text-center relative z-10">
            ...
            {/* Main Headline */}
            <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-semibold text-white mb-8 leading-[1.15] max-w-5xl mx-auto">
            ...
            {/* Subtitle / Intro */}
            <p className="text-zinc-200 text-lg md:text-xl leading-relaxed max-w-4xl mx-auto mb-10 font-light font-manrope">
          ...
          <div className="max-w-screen-2xl mx-auto">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
              <div>
                ...
                <div className="space-y-6 text-zinc-200 text-lg leading-relaxed mb-10 font-manrope">
                  <p>
                ...
                <div className="space-y-4">
                  <div className="flex items-start gap-4 p-4 rounded-xl bg-zinc-900/60 border border-zinc-800">
                    <div className="w-8 h-8 rounded-lg bg-orange-500/20 text-orange-400 font-semibold flex items-center justify-center text-sm shrink-0">1</div>
                    <div>
                      <h4 className="text-white font-semibold text-base">Design & 3D Visualization</h4>
                      <p className="text-zinc-300 text-sm">Visualize your sign with realistic 3D renderings before manufacturing begins.</p>
                    </div>
                  </div>

                  <div className="flex items-start gap-4 p-4 rounded-xl bg-zinc-900/60 border border-zinc-800">
                    <div className="w-8 h-8 rounded-lg bg-orange-500/20 text-orange-400 font-semibold flex items-center justify-center text-sm shrink-0">2</div>
                    <div>
                      <h4 className="text-white font-semibold text-base">In-House Manufacturing</h4>
                      <p className="text-zinc-300 text-sm">Precision fabrication using premium acrylics, ACP sheets, and high-lumen LEDs.</p>
                    </div>
                  </div>

                  <div className="flex items-start gap-4 p-4 rounded-xl bg-zinc-900/60 border border-zinc-800">
                    <div className="w-8 h-8 rounded-lg bg-orange-500/20 text-orange-400 font-semibold flex items-center justify-center text-sm shrink-0">3</div>
                    <div>
                      <h4 className="text-white font-semibold text-base">Professional Installation</h4>
                      <p className="text-zinc-300 text-sm">Safe, durable on-site structural mounting and electrical fitting across Surat.</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="relative bg-zinc-900 rounded-2xl overflow-hidden border border-zinc-800 shadow-2xl">
                  ...
                  <div className="p-6 bg-zinc-900/90 border-t border-zinc-800 flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-zinc-400 text-xs">Dream Shoppers, Dindoli, Surat</p>
                    </div>
                    <span className="text-orange-400 font-semibold text-sm bg-orange-500/10 px-3 py-1.5 rounded-lg border border-orange-500/20">
                      6+ Years
                    </span>
                  </div>
                </div>
        ...
        <section className="w-full bg-black py-24 px-6 md:px-12 lg:px-24">
          <div className="max-w-screen-2xl mx-auto">
            <div className="text-center max-w-3xl mx-auto mb-16">
              ...
              <p className="text-zinc-300 text-lg font-manrope">
              ...
              {aboutContent.whatWeDo.services.map((service, index) => (
                ...
                >
                  <div>
                    ...
                    <p className="text-zinc-300 text-base leading-relaxed mb-6 font-manrope">
                      {service.description}
                    </p>
                  </div>
                  <Link
        ...
        <section className="w-full bg-gradient-to-r from-zinc-950 via-orange-950/30 to-zinc-950 py-16 px-6 md:px-12 border-y border-zinc-800">
          <div className="max-w-screen-xl mx-auto text-center">
            ...
            <p className="text-zinc-300 text-lg mb-8 max-w-2xl mx-auto font-manrope">
              Get a free design consultation and quote from Surat's trusted premium signage experts.
            </p>
            <div className="flex flex-wrap justify-center items-center gap-4">
              <Link
                to="/contact"
                className="inline-flex items-center gap-3 bg-gradient-to-r from-orange-500 to-amber-600 hover:from-orange-600 hover:to-amber-700 text-black font-semibold px-8 py-4 rounded-xl shadow-lg shadow-orange-500/25 transition-all"
              >
                <span>Get a Free Design Consultation →</span>
              </Link>
              <a
          ...
          <div className="max-w-screen-2xl mx-auto">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
              ...
              <div>
                ...
                <p className="text-zinc-300 text-lg mb-8 leading-relaxed font-manrope">
                  {aboutContent.visitUs.description}
                </p>
                <div className="space-y-6 mb-10">
                  <div className="p-4 rounded-xl bg-zinc-900/60 border border-zinc-800">
                    <h3 className="text-white font-semibold text-lg mb-1">Address</h3>
                    <p className="text-zinc-300 text-base">{aboutContent.visitUs.address.line1}</p>
                    <p className="text-zinc-300 text-base">{aboutContent.visitUs.address.line2}</p>
                  </div>
                  <div className="p-4 rounded-xl bg-zinc-900/60 border border-zinc-800">
                    <h3 className="text-white font-semibold text-lg mb-1">Working Hours</h3>
                    <p className="text-zinc-300 text-base">{aboutContent.visitUs.hours}</p>
                  </div>
                  <a
                    href={`https://www.google.com/maps/search/?api=1&query=${encodeURIComponent(aboutContent.visitUs.address.mapQuery)}`}
                    target="_blank"
                    rel="noopener noreferrer"
                    aria-label="View GraphicX Studio reviews on Google"
                  ...
                  >
                    <span className="text-amber-400 text-3xl" aria-hidden="true">★</span>
                    <div>
                      <span className="text-white font-semibold text-xl block leading-tight">4.9 / 5.0 Google Rating</span>
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  aria-label="Get Directions to GraphicX Studio on Google Maps"
                  className="inline-flex items-center gap-2 bg-amber-500 hover:bg-amber-600 text-black font-semibold px-8 py-4 rounded-xl transition-all duration-300"
                >

...
export const aboutContent = {
  ...
  visitUs: {
    ...
    address: {
      ...
      line2: "Near Dindoli Police Station, Dindoli, Surat, Gujarat 394210",
      mapQuery: "Graphicx Studio, Dream Shoppers, Dindoli, Surat",
    },
    hours: "Monday to Saturday | 10:30 AM – 8:00 PM (Closed on Sundays)",
    rating: "4.9",
  },
...
export const heroContent = {
  ...
  stats: [
    ...
    { value: "100", valueSuffix: "%", label: "Satisfaction", accentColor: "#7b61ff" },
  ],
};
